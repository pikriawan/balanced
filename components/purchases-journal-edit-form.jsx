...
import { editPurchasesJournal } from "@/actions/journal";
...
export default function PurchasesJournalEditForm({ companyId, accounts, journal }) {
    ...
    async function onSubmit(event) {
        ...
        const response = await editPurchasesJournal(companyId, journal.id, formData);
