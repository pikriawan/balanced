...
export default function JournalDateFilter() {
    ...
    return (
        <div className="w-full flex flex-col gap-2">
            <Field>
                <FieldLabel htmlFor="journalFilter_startDate">Dari</FieldLabel>
                <TextField
                    className="w-full max-w-3xs"
                    id="journalFilter_startDate"
                    name="startDate"
                    type="date"
            ...
            <Field>
                <FieldLabel htmlFor="journalFilter_endDate">Hingga</FieldLabel>
                <TextField
                    className="w-full max-w-3xs"
                    id="journalFilter_endDate"
                    name="endDate"
                    type="date"
